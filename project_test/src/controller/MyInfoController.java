...
public class MyInfoController {
	...
	@FXML
	private ChoiceBox<String> guField;
	@FXML
    ...
    public void initialize() {
		...
		ObservableList<String> guOptions = FXCollections.observableArrayList(
	            "중구", "유성구", "서구", "동구", "대덕구"
	        );
		guField.setItems(guOptions);
	    guField.setValue(userGu);
    }
